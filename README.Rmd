...
- rfcipCalcPass — R implementations of calculators and tables used in FCIP Policy Acceptance and Storage System (PASS)
- rfcipCalibrate — R Tools for calibrating yield and preference models for farm-level Federal Crop Insurance Program (FCIP) experience
- rfcipCalibrateExtended — Extended tools for rfcipCalibrate
- rfcipReSim — R Modular Simulator for FCIP Reinsurance Outcomes
- arpcPriceBasis — R Tools for Price and basis by Commodity and County/elevator
- arpcCost — R Tools to calibrate and harmonize agricultural production costs by commodity and county

---

**🔁 Replication Packages**  

- [HiddenSafetynet2025](https://github.com/ftsiboe/HiddenSafetynet2025) — Hidden Safety Net of Underutilized Supplemental Insurance in US Agriculture  
- fcipRateRevisions — Replication package for studies examining the impacts of rating revisions in United States agricultural insurance
