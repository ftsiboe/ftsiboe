...
- 📚 **[Publications — Risk Management](https://ftsiboe.github.io/ftsiboe/risk-management/)** — my publications organized by broad topic area, each linked to its publicly available version (journal DOI, USDA-ERS, or ARPC).
- 📝 **[Working Papers](https://ftsiboe.github.io/ftsiboe/working-papers/)** — pre-prints and works in progress (PDFs hosted in this repo).
- 📦 **[R Packages](https://ftsiboe.github.io/ftsiboe/r-packages/)** — public and in-development R packages for agricultural risk and policy analysis.
- 🔁 **[Replication Packages](https://ftsiboe.github.io/ftsiboe/replication-packages/)** — code and data to reproduce my published studies.
- 📊 **[Research Metrics](https://ftsiboe.github.io/ftsiboe/metrics/)** — live citation counts, h-index, and i10-index from Google Scholar.
