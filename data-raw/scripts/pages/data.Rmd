...
distributed as GitHub releases of the
[USFarmSafetyNetLab](https://github.com/ftsiboe/USFarmSafetyNetLab) repository.
Each card links to a release, which documents the included files, methodology,
and recommended citation; most files are `.rds` objects downloadable directly
in R with `piggyback`.
