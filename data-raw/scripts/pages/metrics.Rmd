...
Citation metrics from my [Google Scholar profile](https://scholar.google.com/citations?user=ox2t_YIAAAAJ&hl=en).
...
The badges above read [`data-raw/scholar-metrics.json`](https://github.com/ftsiboe/ftsiboe/blob/main/data-raw/scholar-metrics.json), which the **Update Scholar Metrics** GitHub Actions workflow (`.github/workflows/R-google-scholar-profile.yaml`) refreshes from Google Scholar on a weekly and monthly schedule. Because the badges are read live, the numbers stay current without rebuilding this site.
