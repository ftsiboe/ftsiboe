...
My publications, searchable and filterable by area, sub-topic, year, and
outlet.
...
.pub-controls select:disabled{opacity:0.5;}
...
<select id="pub-sub" aria-label="Filter by sub-topic" disabled>
<option value="">All sub-topics</option> </select>
<select id="pub-year" aria-label="Filter by year"> <option value="">All
years</option> <option value="2026">2026</option>
...
<option value="2015">2015</option> <option value="2012">2012</option>
</select> <select id="pub-outlet" aria-label="Filter by outlet">
<option value="">All outlets</option> <option value="AEPP">AEPP</option>
<option value="AfJARE">AfJARE</option> <option value="AFR">AFR</option>
<option value="Agrekon">Agrekon</option>
<option value="Agribusiness">Agribusiness</option>
<option value="Agricultural Economics">Agricultural Economics</option>
<option value="Agricultural Finance Review">Agricultural Finance
Review</option>
<option value="Agricultural Water Management">Agricultural Water
Management</option> <option value="Agronomy Journal">Agronomy
Journal</option> <option value="AJAE">AJAE</option>
<option value="ARER">ARER</option> <option value="ARPC Brief">ARPC
Brief</option> <option value="ARPC Report">ARPC Report</option>
<option value="ARPC White Paper">ARPC White Paper</option>
<option value="ARPC Working Paper">ARPC Working Paper</option>
<option value="Book Chapter">Book Chapter</option>
<option value="Energy Policy">Energy Policy</option>
<option value="Food Control">Food Control</option>
<option value="Food Policy">Food Policy</option>
<option value="Ghana Journal of Development Studies">Ghana Journal of
Development Studies</option> <option value="JAAE">JAAE</option>
<option value="JAAEA">JAAEA</option>
<option value="JADEE">JADEE</option> <option value="JARE">JARE</option>
<option value="Journal of Agricultural Science">Journal of Agricultural
Science</option>
<option value="Journal of International Development">Journal of
International Development</option>
<option value="Journal of Rural Studies">Journal of Rural
Studies</option>
<option value="Journal of Soil and Water Conservation">Journal of Soil
and Water Conservation</option> <option value="JPA">JPA</option>
<option value="JRI">JRI</option> <option value="New Medit">New
Medit</option> <option value="PLOS ONE">PLOS ONE</option>
<option value="RoDE">RoDE</option> <option value="SAEA">SAEA</option>
<option value="Scientific African">Scientific African</option>
<option value="Social Indicators Research">Social Indicators
Research</option> <option value="SSRN">SSRN</option>
<option value="USDA ERS EB">USDA ERS EB</option>
<option value="USDA ERS EIB">USDA ERS EIB</option>
<option value="World Development">World Development</option> </select>
...
<script>
var PUB_SUBS = {"risk-management":[["background-and-policy","Background &amp; policy"],["crop-insurance-demand","Crop insurance demand"],["crop-insurance-rating","Crop insurance rating"],["prevented-planting","Prevented planting"],["premium-and-interest-deferrals","Premium &amp; interest deferrals"],["yield-modeling","Yield modeling"],["index-insurance","Index insurance"],["impacts-of-crop-insurance","Impacts of crop insurance"],["safety-net-simulation","Safety-net simulation"],["climate-and-environment","Climate &amp; environment"]]};
(function(){
  ...
  var search=document.getElementById("pub-search"), area=document.getElementById("pub-area");
  var sub=document.getElementById("pub-sub"), year=document.getElementById("pub-year"), outlet=document.getElementById("pub-outlet");
  var count=document.getElementById("pub-count"), empty=document.getElementById("pub-empty");
  function fillSub(){
    var subs=PUB_SUBS[area.value]||[];
    var h='<option value="">All sub-topics</option>';
    subs.forEach(function(s){h+='<option value="'+s[0]+'">'+s[1]+'</option>';});
    sub.innerHTML=h; sub.disabled=subs.length===0; sub.value="";
  }
  function apply(){
    var q=(search.value||"").toLowerCase().trim();
    var af=area.value, sf=sub.value, yf=year.value, of=outlet.value, shown=0;
    items.forEach(function(it){
      var vis=(!q||it.getAttribute("data-text").indexOf(q)>-1)
        &&(!af||it.getAttribute("data-area")===af)
        &&(!sf||it.getAttribute("data-topic")===sf)
        &&(!yf||it.getAttribute("data-year")===yf)
        &&(!of||it.getAttribute("data-venue")===of);
      it.style.display=vis?"":"none"; if(vis){shown++;}
    });
  ...
  area.addEventListener("change",function(){fillSub();apply();});
  sub.addEventListener("change",apply); year.addEventListener("change",apply);
  outlet.addEventListener("change",apply); search.addEventListener("input",apply);
  apply();
})();
</script>
