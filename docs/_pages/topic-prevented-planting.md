---
layout: archive
title: "Prevented planting"
permalink: /publications/prevented-planting/
author_profile: true
---


<!-- SOURCE for the "Prevented planting" topic page (docs/_pages/topic-prevented-planting.md).
     ...
     topic == "prevented-planting". Build with data-raw/scripts/render.R (knit_root_dir = root). -->
