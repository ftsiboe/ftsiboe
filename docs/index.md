...
**I build the evidence and the open-source tools behind the U.S. farm
safety net.**
...
- **Farm safety net & risk policy:** the Federal Crop Insurance Program
  (FCIP), Price Loss Coverage and Agriculture Risk Coverage (PLC/ARC),
